...
fn detects_signature_and_encryption() {
    ...
    let sig_report = ysnp_core::runner::run_scan_with_detectors(sig, opts.clone(), &detectors)
    ...
    let enc_report = ysnp_core::runner::run_scan_with_detectors(enc, opts, &detectors)
