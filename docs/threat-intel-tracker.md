...
| 2026-02-02 | CVE-2021-30860 zero-click JBIG2 strip | Image codecs / zero-click JBIG2 | `FilterChainAnomalyDetector`, `ImageAnalysisDetector` | High | High | Strong | Zero-click JBIG2 detection (1×N strips) added, emits `cve=CVE-2021-30860` and `attack_surface=Image codecs / zero-click JBIG2`. |
