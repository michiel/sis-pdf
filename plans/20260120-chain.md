...
- JSON/SARIF outputs should include the same grouping metadata as text output.
- Chain grouping should be the default; add a CLI flag to disable (e.g. `--ungroup-chains`).
